...
ArrayList<prodotto>	lista = prodJDBCTemp.getLista();
  ...
  public ResponseEntity<String> getConferma(@RequestParam("mail") String mail, @RequestParam("somma") String somma, @RequestParam("token") String token) throws MessagingException{
	  ...
	  String to = mail;
		 ...
		 text += "Il prezzo totale da pagare è " + sommaO + " euro";
		  ...
		  double totale = Double.parseDouble(somma);
		  ...
		  try {
	            ...
	            ChargeCreateParams params = ChargeCreateParams.builder()
	                    .setAmount((long) totale) // Importo in centesimi
	                    .setCurrency("eur")
	            ...
	            return ResponseEntity.ok("Conferma dell'avvenuto acquisto, guarda la tua mail");
	        	 ...
	        	 return ResponseEntity.ok("Qualcosa è andato storto. Riprova");
	        }
